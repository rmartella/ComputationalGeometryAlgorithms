...
int main(int argc, char ** argv) {
	float center[3] = { 2.5, 0, 0 };
	float boxhalfsize[3] = { 1.0, 1.0, 1.0 };
	float triverts[3][3] = { { 0.5, 0.5, 0.5f }, { 1.5, 0.5, 0.5 }, { 0.5, 0.25,
			0.5 } };
	int test = triBoxOverlap(center, boxhalfsize, triverts);
